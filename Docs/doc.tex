...
un istoric al documentelor medicale (analize, teste) și un istoric al medicamentelor folosite de utilizator.
...
TODO sa le adaug cand is sigur ce face aplicatia
...
\begin{figure}[H]
\centering
\includegraphics[width=8cm, height=4cm]{patch.png}
\caption{Exemplu de metoda PATCH folosita pentru modificarea de resurse
\end{figure}
